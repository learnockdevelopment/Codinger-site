...
class SectionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      Section::updateOrCreate(['id' => 500], ['name' => 'admin_vouchers', 'caption' => 'Vouchers']);
...
Section::updateOrCreate(['id' => 500], ['name' => 'admin_vouchers', 'caption' => 'Vouchers']);
Section::updateOrCreate(['id' => 501], ['name' => 'admin_vouchers_list', 'section_group_id' => 600, 'caption' => 'Vouchers list']);
Section::updateOrCreate(['id' => 502], ['name' => 'admin_vouchers_create', 'section_group_id' => 600, 'caption' => 'Vouchers create']);
Section::updateOrCreate(['id' => 503], ['name' => 'admin_vouchers_edit', 'section_group_id' => 600, 'caption' => 'Vouchers edit']);
Section::updateOrCreate(['id' => 504], ['name' => 'admin_vouchers_delete', 'section_group_id' => 600, 'caption' => 'Vouchers delete']);
Section::updateOrCreate(['id' => 505], ['name' => 'admin_vouchers_export', 'section_group_id' => 600, 'caption' => 'Vouchers export excel']);
