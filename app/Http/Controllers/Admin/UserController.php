...
class UserController extends Controller
{
    ...
    'full_arabic_name' => $data['full_arabic_name'] ?? $data['full_name'],  // Add Arabic full name
    'role_name' => $role->name, 
    ...
    public function update(Request $request, $id)
    {
        ...
        $user->full_name = !empty($data['full_name']) ? $data['full_name'] : $user->full_name;
$user->full_arabic_name = !empty($data['full_arabic_name']) ? $data['full_arabic_name'] : $user->full_arabic_name;
...
$user->mac_address = !empty($data['mac_address']) ? $data['mac_address'] : null;
 ...
 public function updateDevice(Request $request, $id)
    {
        ...
        $user->mac_address = !empty($data['mac_address']) ? $data['mac_address'] : null;
   $user->device_id = !empty($data['device_id']) ? $data['device_id'] : null;
		$user->save();
