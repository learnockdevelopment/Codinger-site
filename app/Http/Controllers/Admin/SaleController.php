    ...
    public function index(Request $request)
{
    ...
    // Appointment sales after filters
    $appointmentSales = [
    ...
    // Failed sales (no filter here, assuming you want this count always for failed orders)
    ...
    foreach ($sales as $sale) {
        ...
        // Ensure there's a sale log entry
    ...
    // Apply filters for teachers, students, and webinars if provided
