...
class Setting extends Model implements TranslatableContract
{
    ...
    static $seoMetas, $socials,
        ...
        $contactPage, $Error404Page, $navbarLink,$aboutSection, $panelSidebar, $findInstructors, $rewardProgram, $rewardsSettings, $storeSettings,
    ...
    static $navbarLinkName = 'navbar_links';
      static $aboutSectionName = 'about_section';
     ...
     * @return array
     */
    static function getAboutSectionSettings($key = null)
    {
        return self::getSetting(self::$aboutSection, self::$aboutSectionName, $key);
    }
