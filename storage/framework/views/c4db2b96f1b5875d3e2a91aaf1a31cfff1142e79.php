...
<?php
    $authUser->full_name = (app()->getLocale() === 'ar' && !is_null($authUser->full_arabic_name)) ? $authUser->full_arabic_name : $authUser->full_name;
?>
    <div class="custom-dropdown navbar-auth-user-dropdown position-relative ml-20" >
        <div class="custom-dropdown-toggle d-flex align-items-center navbar-user cursor-pointer">
            <img 
    src="<?php echo e($authUser->avatar ?: '/store/1/default.png'); ?>" 
    class="rounded-circle size-40" 
    alt="<?php echo e($authUser->full_name); ?>">
            <span class="font-16 user-name ml-10 text-dark-blue font-14 lg:inline-block! hidden!"><?php echo e($authUser->full_name); ?></span>
        </div>
...
<?php else: ?>
    <!-- <div class="d-flex align-items-center ml-md-50"> -->
       <!-- <a href="/login" class="py-5 px-10 mr-10 text-dark-blue font-14" style="font-size:22px;color:#C833E2;"><?php echo e(trans('auth.login')); ?></a> -->
      <!--  <a href="/register" class="py-5 px-10 mr-10 text-dark-blue font-14" style="font-size:22px;color:#C833E2;"><?php echo e(trans('auth.register')); ?></a> -->
    <!-- </div> -->
<?php endif; ?>
<?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/web/default/includes/top_nav/user_menu.blade.php ENDPATH**/ ?>