...
<div class="form-group">
    <label><?php echo e(trans('/admin/main.full_arabic_name')); ?></label>
    <input type="text" name="full_arabic_name"
           class="form-control  <?php $__errorArgs = ['full_arabic_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
           value="<?php echo e(!empty($user) ? $user->full_arabic_name : old('full_arabic_name')); ?>"
           placeholder="<?php echo e(trans('admin/main.full_arabic_name')); ?>"/>
    <?php $__errorArgs = ['full_arabic_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/users/editTabs/general.blade.php ENDPATH**/ ?>