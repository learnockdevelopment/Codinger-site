<?php
    ...
    $smsChannel = getSMSChannelsSettings("sms_sending_channel");
?>
    ...
    <div class="d-flex align-items-center wizard-custom-radio mb-20">
      ...
      <div class="wizard-custom-radio-item flex-grow-1">
            <input type="radio" name="type" value="email" id="emailType" class="" 
                <?php echo e((($registerMethod == 'email' and empty(old('type'))) or old('type') == "email" or $smsChannel == 'smsmisr') ? 'checked' : ''); ?>>
            <label class="font-12 cursor-pointer px-15 py-10" for="emailType"><?php echo e(trans('public.email')); ?></label>
        </div>
        <?php endif; ?>
    </div>

    <div class="js-email-fields form-group <?php echo e((($registerMethod == 'email' or $smsChannel == 'smsmisr' and empty(old('type'))) or old('type') == "email") ? '' : 'd-none'); ?>">
...
<?php else: ?>
    <?php if($registerMethod == 'mobile' && $smsChannel != 'smsmisr'): ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/web/default/auth/includes/register_methods_forget.blade.php ENDPATH**/ ?>