    ...
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_bundles')): ?>
                <li
                    class="nav-item dropdown <?php echo e((request()->is(getAdminPanelUrl('/bundles*', false)) and !request()->is(getAdminPanelUrl('/bundles/comments*', false))) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_bundles_list')): ?>
                            <li
                                class="<?php echo e((request()->is(getAdminPanelUrl('/bundles', false)) and request()->get('type') == 'course') ? 'active' : ''); ?>">
                                <a href="<?php echo e(getAdminPanelUrl()); ?>/bundles"
                                    class="nav-link <?php if(!empty($sidebarBeeps['bundles']) and $sidebarBeeps['bundles']): ?> beep beep-sidebar <?php endif; ?>"><?php echo e(trans('admin/main.lists')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_bundles_create')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/bundles/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/bundles/create"><?php echo e(trans('admin/main.new')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_upcoming_courses')): ?>
                <li
                    class="nav-item dropdown <?php echo e((request()->is(getAdminPanelUrl('/upcoming_courses*', false)) and !request()->is(getAdminPanelUrl('/upcoming_courses/comments*', false))) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_upcoming_courses_list')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/upcoming_courses', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/upcoming_courses')); ?>"><?php echo e(trans('admin/main.lists')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_upcoming_courses_create')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/upcoming_courses/new', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/upcoming_courses/new')); ?>"><?php echo e(trans('admin/main.new')); ?></a>
                            </li>
                        <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_certificate')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/certificates*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_certificate_list')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/certificates', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/certificates"><?php echo e(trans('update.quizzes_related')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_course_certificate_list')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/certificates/course-competition', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/certificates/course-competition"><?php echo e(trans('update.course_certificates')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_certificate_template_list')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/certificates/templates', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_certificate_template_create')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/certificates/templates/new', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_certificate_settings')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/certificates/settings', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_course_noticeboards_list')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/course-noticeboards*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_course_noticeboards_list')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/course-noticeboards', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/course-noticeboards"><?php echo e(trans('admin/main.lists')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_course_noticeboards_send')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/course-noticeboards/send', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/course-noticeboards/send"><?php echo e(trans('admin/main.new')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_enrollment')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/enrollments*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_enrollment_history')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/enrollments/history', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/enrollments/history"><?php echo e(trans('public.history')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_enrollment_add_student_to_items')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/enrollments/add-student-to-class', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/enrollments/add-student-to-class"><?php echo e(trans('update.add_student_to_a_class')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
          <li
    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/financial/qrcodes*', false)) ? 'active' : ''); ?>">
    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
        <i class="fas fa-qrcode"></i>
        <span><?php echo e(trans('admin/main.qrcodes')); ?></span>
    </a>
    <ul class="dropdown-menu">
        <li
            class="<?php echo e((request()->is(getAdminPanelUrl('/financial/qrcodes', false)) and empty(request()->get('instructor_qrcodes'))) ? 'active' : ''); ?>">
            <a class="nav-link"
                href="<?php echo e(getAdminPanelUrl()); ?>/financial/qrcodes"><?php echo e(trans('admin/main.qr_lists')); ?></a>
        </li>
        
        <li
            class="<?php echo e(request()->is(getAdminPanelUrl('/financial/qrcodes/new', false)) ? 'active' : ''); ?>">
            <a class="nav-link"
                href="<?php echo e(getAdminPanelUrl()); ?>/financial/qrcodes/new"><?php echo e(trans('admin/main.new_qrcode')); ?></a>
        </li>
    </ul>
</li>
            <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_categories')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/categories*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fas fa-th"></i>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_categories')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/subject*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
				<i class="fas fa-table"></i>   
                      <span><?php echo e(trans('admin/main.subject_section')); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_categories_list')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/subject', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/subject"><?php echo e(trans('admin/main.lists')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_categories_create')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/subject/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/subject/create"><?php echo e(trans('admin/main.new')); ?></a>
                            </li>
                        <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_filters')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/filters*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
            ...
            <?php if($authUser->can('admin_consultants_lists') or $authUser->can('admin_appointments_lists')): ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_users_not_access_content_lists')): ?>
                <li
                    class="<?php echo e(request()->is(getAdminPanelUrl('/users/not-access-to-content', false)) ? 'active' : ''); ?>">
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_group_create')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/users/groups/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
            ...
            <?php if($authUser->can('admin_user_login_history') or $authUser->can('admin_user_ip_restriction')): ?>
                <li
                    class="nav-item dropdown <?php echo e((request()->is(getAdminPanelUrl('/users/login-history*', false)) or request()->is(getAdminPanelUrl('/users/ip-restriction*', false))) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_user_login_history')): ?>
                            <li
                                class="nav-item <?php echo e(request()->is(getAdminPanelUrl('/users/login-history*', false)) ? 'active' : ''); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_user_ip_restriction')): ?>
                            <li
                                class="nav-item <?php echo e(request()->is(getAdminPanelUrl('/users/ip-restriction*', false)) ? 'active' : ''); ?>">
            ...
            <?php if($authUser->can('admin_forum') or $authUser->can('admin_featured_topics')): ?>
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_forum_list')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/forums', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/forums"><?php echo e(trans('admin/main.lists')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_forum_create')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/forums/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/forums/create"><?php echo e(trans('admin/main.new')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_featured_topics')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/featured-topics*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_featured_topics_list')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/featured-topics', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/featured-topics"><?php echo e(trans('admin/main.lists')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_featured_topics_create')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/featured-topics/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/featured-topics/create"><?php echo e(trans('admin/main.new')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_recommended_topics')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/recommended-topics*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_recommended_topics_list')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/recommended-topics', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/recommended-topics"><?php echo e(trans('admin/main.lists')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_recommended_topics_create')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/recommended-topics/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/recommended-topics/create"><?php echo e(trans('admin/main.new')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_noticeboards')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/noticeboards*', false)) ? 'active' : ''); ?>">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_noticeboards_list')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/noticeboards', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/noticeboards"><?php echo e(trans('admin/main.lists')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_noticeboards_send')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/noticeboards/send', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/noticeboards/send"><?php echo e(trans('admin/main.new')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_notifications_send')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/notifications/send', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store')): ?>
                <li
                    class="nav-item dropdown <?php echo e((request()->is(getAdminPanelUrl('/store*', false)) or request()->is(getAdminPanelUrl('/comments/products*', false))) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_new_product')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/store/products/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/products/create"><?php echo e(trans('update.new_product')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_products')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/store/products', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/products"><?php echo e(trans('update.products')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_in_house_products')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/store/in-house-products', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/in-house-products"><?php echo e(trans('update.in-house-products')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_products_orders')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/store/orders', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/orders"><?php echo e(trans('update.orders')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_in_house_orders')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/store/in-house-orders', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/in-house-orders"><?php echo e(trans('update.in-house-orders')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_products_sellers')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/store/sellers', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/sellers"><?php echo e(trans('update.sellers')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_categories_list')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/store/categories', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/categories"><?php echo e(trans('admin/main.categories')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_filters_list')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/store/filters', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/filters"><?php echo e(trans('update.filters')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_specifications')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/store/specifications', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/specifications"><?php echo e(trans('update.specifications')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_discounts')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/store/discounts', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/discounts"><?php echo e(trans('admin/main.discounts')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_products_comments')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/comments/products*', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/comments/products"><?php echo e(trans('admin/main.comments')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_products_comments_reports')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/comments/products/reports', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/comments/products/reports"><?php echo e(trans('admin/main.comments_reports')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_products_reviews')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/store/reviews', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/reviews"><?php echo e(trans('admin/main.reviews')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_store_settings')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/store/settings', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/store/settings"><?php echo e(trans('admin/main.settings')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_additional_pages_404')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/additional_page/404', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                        ...
                        <?php endif; ?>
                      <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/additional_page/about_section', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/additional_page/about_section"><?php echo e(trans('admin/main.about')); ?></a>
                            </li>
                    </ul>
                </li>
            <?php endif; ?>
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_testimonials_create')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/testimonials/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_regions')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/regions*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_regions_countries')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/regions/countries', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/regions/countries"><?php echo e(trans('update.countries')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_regions_provinces')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/regions/provinces', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/regions/provinces"><?php echo e(trans('update.provinces')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_regions_cities')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/regions/cities', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/regions/cities"><?php echo e(trans('update.cities')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_regions_districts')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/regions/districts', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/regions/districts"><?php echo e(trans('update.districts')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_forms_create')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/forms/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/forms/create"><?php echo e(trans('admin/main.new')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_forms_lists')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/forms', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/forms"><?php echo e(trans('admin/main.lists')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_forms_submissions')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/forms/submissions', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/forms/submissions"><?php echo e(trans('update.submissions')); ?></a>
                            </li>
                        <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_ai_contents')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/ai-contents*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_ai_contents_lists')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/ai-contents/lists', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/ai-contents/lists"><?php echo e(trans('update.generated_contents')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_ai_contents_templates_create')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/ai-contents/templates/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/ai-contents/templates/create"><?php echo e(trans('update.new_template')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_ai_contents_templates_lists')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/ai-contents/templates', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/ai-contents/templates"><?php echo e(trans('update.service_template')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_ai_contents_settings')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/ai-contents/settings', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/ai-contents/settings"><?php echo e(trans('update.settings')); ?></a>
                            </li>
                        <?php endif; ?>
            ...
            <?php endif; ?>
            <li
                class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/financial/vouchers*', false)) ? 'active' : ''); ?>">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fas fa-ticket-alt"></i>
                    <span><?php echo e(trans('admin/main.vouchers')); ?></span>
                </a>
                <ul class="dropdown-menu">
                    <li
                        class="<?php echo e((request()->is(getAdminPanelUrl('/financial/vouchers', false)) and empty(request()->get('instructor_vouchers'))) ? 'active' : ''); ?>">
                        <a class="nav-link"
                            href="<?php echo e(getAdminPanelUrl()); ?>/financial/vouchers"><?php echo e(trans('admin/main.lists')); ?></a>

                    <li
                        class="<?php echo e(request()->is(getAdminPanelUrl('/financial/vouchers/new', false)) ? 'active' : ''); ?>">
                        <a class="nav-link"
                            href="<?php echo e(getAdminPanelUrl()); ?>/financial/vouchers/new"><?php echo e(trans('admin/main.new')); ?></a>
                    </li>
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_documents_list')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/documents', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
            ...
            <?php endif; ?>
<li class="nav-item <?php echo e(request()->is(getAdminPanelUrl('/financial/sales*', false)) ? 'active' : ''); ?>">
        <a href="<?php echo e(getAdminPanelUrl()); ?>/financial/sales?status=refund" class="nav-link">
            <i class="fas fa-list-ul"></i>
            <span><?php echo e(trans('admin/main.refund_list')); ?></span>
        </a>
    </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_offline_payments_list')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/financial/offline_payments*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown"><i class="fas fa-university"></i>
                        <span><?php echo e(trans('admin/main.offline_payments')); ?></span></a>
                    <ul class="dropdown-menu">
                        <li
                            class="<?php echo e((request()->is(getAdminPanelUrl('/financial/offline_payments', false)) and request()->get('page_type') == 'requests') ? 'active' : ''); ?>">
                            <a href="<?php echo e(getAdminPanelUrl()); ?>/financial/offline_payments?page_type=requests"
                                class="nav-link <?php if(!empty($sidebarBeeps['offlinePayments']) and $sidebarBeeps['offlinePayments']): ?> beep beep-sidebar <?php endif; ?>">
                                <span><?php echo e(trans('panel.requests')); ?></span>
                            </a>
                        </li>

                        <li
                            class="<?php echo e((request()->is(getAdminPanelUrl('/financial/offline_payments', false)) and request()->get('page_type') == 'history') ? 'active' : ''); ?>">
                            <a href="<?php echo e(getAdminPanelUrl()); ?>/financial/offline_payments?page_type=history"
                                class="nav-link">
                                <span><?php echo e(trans('public.history')); ?></span>
                            </a>
                        </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_subscribe')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/financial/subscribes*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_subscribe_list')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/subscribes', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/financial/subscribes"><?php echo e(trans('admin/main.packages')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_subscribe_create')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/subscribes/new', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/financial/subscribes/new"><?php echo e(trans('admin/main.new_package')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_rewards')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/rewards*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_rewards_history')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/rewards', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/rewards"><?php echo e(trans('public.history')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_rewards_items')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/rewards/items', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/rewards/items"><?php echo e(trans('update.conditions')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_rewards_settings')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/rewards/settings', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/rewards/settings"><?php echo e(trans('admin/main.settings')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_registration_packages')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/financial/registration-packages*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fa fa-gem"></i>
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_registration_packages_lists')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/registration-packages', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/financial/registration-packages"><?php echo e(trans('admin/main.packages')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_registration_packages_new')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/registration-packages/new', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/financial/registration-packages/new"><?php echo e(trans('admin/main.new_package')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_registration_packages_reports')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/registration-packages/reports', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/financial/registration-packages/reports"><?php echo e(trans('admin/main.reports')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_registration_packages_settings')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/registration-packages/settings', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/financial/registration-packages/settings"><?php echo e(trans('admin/main.settings')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_installments')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/financial/installments*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_installments_create')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/installments/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/financial/installments/create')); ?>"><?php echo e(trans('update.new_plan')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_installments_list')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/installments', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/financial/installments')); ?>"><?php echo e(trans('update.plans')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_installments_purchases')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/installments/purchases', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/financial/installments/purchases')); ?>"><?php echo e(trans('update.purchases')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_installments_overdue_lists')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/installments/overdue', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/financial/installments/overdue')); ?>"><?php echo e(trans('update.overdue')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_installments_overdue_history')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/installments/overdue_history', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/financial/installments/overdue_history')); ?>"><?php echo e(trans('update.overdue_history')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_installments_verification_requests')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/installments/verification_requests', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/financial/installments/verification_requests')); ?>"><?php echo e(trans('update.verification_requests')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_installments_verified_users')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/installments/verified_users', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/financial/installments/verified_users')); ?>"><?php echo e(trans('update.verified_users')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_installments_settings')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/financial/installments/settings', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/financial/installments/settings')); ?>"><?php echo e(trans('admin/main.settings')); ?></a>
                            </li>
                        <?php endif; ?>
            ...
            <?php if(
                $authUser->can('admin_discount_codes') or
                    $authUser->can('admin_vouchers') or
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_abandoned_cart')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/abandoned-cart*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_abandoned_cart_rules')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/abandoned-cart/rules/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/abandoned-cart/rules/create')); ?>"><?php echo e(trans('update.new_rule')); ?></a>
                            </li>

                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/abandoned-cart/rules', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/abandoned-cart/rules')); ?>"><?php echo e(trans('update.rules')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_abandoned_cart_users')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/abandoned-cart/users-carts', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/abandoned-cart/users-carts')); ?>"><?php echo e(trans('update.users_carts')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_abandoned_cart_settings')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/abandoned-cart/settings', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/abandoned-cart/settings')); ?>"><?php echo e(trans('update.settings')); ?></a>
                            </li>
                        <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_cashback')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/cashback*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_cashback_rules')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/cashback/rules/new', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/cashback/rules/new')); ?>"><?php echo e(trans('update.new_rule')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_cashback_rules')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/cashback/rules', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/cashback/rules')); ?>"><?php echo e(trans('update.rules')); ?></a>
                            </li>
                        <?php endif; ?>

                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_cashback_transactions')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/cashback/transactions', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/cashback/transactions')); ?>"><?php echo e(trans('update.transactions')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_cashback_history')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/cashback/history', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/cashback/history')); ?>"><?php echo e(trans('update.history')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_gift_history')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/gifts', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/gifts')); ?>"><?php echo e(trans('public.history')); ?></a>
                            </li>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_gift_settings')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/gifts/settings', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/gifts/settings')); ?>"><?php echo e(trans('admin/main.settings')); ?></a>
                            </li>
                        <?php endif; ?>
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_advertising_banners')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/advertising/banners', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_newsletters_history')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/newsletters/history', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_referrals')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/referrals*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_referrals_history')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/referrals/history', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/referrals/history"><?php echo e(trans('public.history')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_referrals_users')): ?>
                            <li class="<?php echo e(request()->is(getAdminPanelUrl('/referrals/users', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl()); ?>/referrals/users"><?php echo e(trans('admin/main.affiliate_users')); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </li>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_registration_bonus')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/registration_bonus*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                        <i class="fa fa-gem"></i>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_registration_bonus_history')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/registration_bonus/history', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/registration_bonus/history')); ?>"><?php echo e(trans('update.bonus_history')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_registration_bonus_settings')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/registration_bonus/settings', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/registration_bonus/settings')); ?>"><?php echo e(trans('admin/main.settings')); ?></a>
                            </li>
                        <?php endif; ?>
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_advertising_modal_config')): ?>
                <li
                    class="nav-item <?php echo e(request()->is(getAdminPanelUrl('/advertising_modal*', false)) ? 'active' : ''); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_purchase_notifications')): ?>
                <li
                    class="nav-item dropdown <?php echo e(request()->is(getAdminPanelUrl('/purchase_notifications*', false)) ? 'active' : ''); ?>">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_purchase_notifications_lists')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/purchase_notifications', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/purchase_notifications')); ?>"><?php echo e(trans('admin/main.lists')); ?></a>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin_purchase_notifications_create')): ?>
                            <li
                                class="<?php echo e(request()->is(getAdminPanelUrl('/purchase_notifications/create', false)) ? 'active' : ''); ?>">
                                <a class="nav-link"
                                    href="<?php echo e(getAdminPanelUrl('/purchase_notifications/create')); ?>"><?php echo e(trans('admin/main.new')); ?></a>
                            </li>
                        <?php endif; ?>
...
<?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/includes/sidebar.blade.php ENDPATH**/ ?>