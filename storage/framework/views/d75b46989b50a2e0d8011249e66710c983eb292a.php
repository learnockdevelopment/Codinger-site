                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-8 col-lg-6">
                                    <form action="<?php echo e(getAdminPanelUrl()); ?>/additional_page/about_section/store" method="post">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="input-group">
        <div class="input-group-prepend">
            <button type="button" class="input-group-text admin-file-manager" data-input="link" data-preview="holder">
        ...
        <input type="text"
               name="value[link]"
               id="link"
               value="<?php echo e((!empty($navbar_link)) ? $navbar_link->link : old('value.link')); ?>"
               class="form-control <?php $__errorArgs = ['value.thumbnail'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"/>
        <div class="input-group-append">
            <button type="button" class="input-group-text admin-file-view" data-input="link">
                <i class="fa fa-eye"></i>
            </button>
        </div>
        <?php $__errorArgs = ['value.link'];
...
<div class="form-group">
                                            ...
                                            <input type="text" name="value[description]" value="<?php echo e((!empty($navbar_link)) ? $navbar_link->description : old('value.description')); ?>" class="form-control  <?php $__errorArgs = ['value.description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"/>
                                            <?php $__errorArgs = ['value.description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <?php if(!empty($items)): ?>
                                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo e(getAdminPanelUrl()); ?>/additional_page/about_section/<?php echo e($key); ?>/edit" class="btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo e(trans('admin/main.edit')); ?>">
                                                        <i class="fa fa-edit"></i>
                                                    </a>

                                                    <?php echo $__env->make('admin.includes.delete_button',['url' => getAdminPanelUrl().'/additional_page/about_section/'. $key .'/delete','btnClass' => 'btn-sm'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/additional_pages/about_section.blade.php ENDPATH**/ ?>