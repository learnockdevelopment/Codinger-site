...
<link rel="preload" href="<?php echo e($generalSettings['logo']); ?>" as="image">
<style>
...
<nav id="navbar" class="sticky top-0 z-50 shadow-none navbar navbar-expand-lg p-1  transition-all duration-300 p-[15px_10px] transparent-nav">    <div class="<?php echo e((!empty($isPanel) and $isPanel) ? 'container-fluid' : 'container '); ?>">
  <style>
...
<ul
    x-show="open"
    x-transition
    class="dropdown-hidden absolute top-[100%] mt-0 bg-white border border-gray-200 shadow-md rounded z-50 w-64 <?php echo e(in_array(app()->getLocale(), ['ar']) ? 'left-[-170px]!' : 'left-0'); ?>"
>
                        ...
                        <a href="/contact-us"
                           class="flex items-center justify-between px-4 py-2 hover:bg-gray-100 text-dark">
                            <div class="flex items-center">
                                ...
                                <?php echo e(trans('home.menu_contact')); ?>
 ...
 <li class="d-flex pl-1! pr-6! ">
                        ...
                        <a href="#aboutUs"
                           class="flex items-center justify-between px-4 py-2 hover:bg-gray-100 text-dark">
                            <div class="flex items-center">
                                ...
                                <?php echo e(trans('home.menu_about_us')); ?>
                        ...
                        <a href="#vision"
                           class="flex items-center justify-between px-4 py-2 hover:bg-gray-100 text-dark">
                            <div class="flex items-center">
                              ...
                              <?php echo e(trans('home.menu_vision')); ?>
                        ...
                        <a href="#aq"
                           class="flex items-center justify-between px-4 py-2 hover:bg-gray-100 text-dark">
                            <div class="flex items-center">
                                ...
                                <?php echo e(trans('home.menu_faq')); ?>
                  ...
                  <li class="relative group">
                        <a href="#projects"
                           class="flex items-center justify-between px-4 py-2 hover:bg-gray-100 text-dark">
                            <div class="flex items-center">
                              <i class="fa-solid fa-diagram-project mx-2"  width="20" height="20" ></i>
                               <?php echo e(trans('home.menu_projects')); ?> 
                            </div>
                        </a>
                    </li>
                     <li class="relative group">
                           ...
                           class="flex items-center justify-between px-4 py-2 hover:bg-gray-100 text-dark">
                            <div class="flex items-center">
                              ...
                              <i class="fa-solid fa-comment mx-2"  width="20" height="20" ></i>
                               <?php echo e(trans('home.menu_testimonials')); ?>
                           ...
                           class="flex items-center justify-between px-4 py-2 hover:bg-gray-100 text-dark">
                            <div class="flex items-center">
                              ...
                              <i class="fa-solid fa-trophy mx-2"  width="20" height="20" ></i>
                               <?php echo e(trans('home.menu_prizes')); ?>
        ...
        <a class="navbar-brand navbar-order d-flex align-items-center order-1 lg:order-none mr-0 <?php echo e((empty($navBtnUrl) and empty($navBtnText)) ? 'ml-auto' : ''); ?>"
   href="/" style="width:auto !important;">
    ...
    <?php endif; ?>
            ...
            <?php if(!empty($authUser) && !empty($securitySettings['watermark_enabled']) && $securitySettings['watermark_enabled'] !== 0): ?>
                <div id="floating-user-id" class="floating-user-id"
                    ...
                    ">
                    Email: <?php echo e($authUser->email); ?> <br>
 ...
 <div class="d-flex align-items-center justify-content-between justify-content-md-center  flex! lg:hidden!">
                ...
                <?php endif; ?>
                  ...
                  <?php if(!empty($navbarPages) and count($navbarPages)): ?>
                            ...
                            <li class="nav-item">
<a href="<?php echo e($navbarPage['link']); ?>" 
...
<?php if(empty($authUser)): ?>
            <div class="d-flex align-items-center lg:ml-12 md:ml-auto! order-2 lg:order-none">
                <a href="/login" class="lg:py-5 lg:px-10 md:text-[22px]! lg:mr-6! text-dark-blue font-14"
                    style="color:#C833E2;font-weight:bold;"><?php echo e(trans('auth.login')); ?></a>
            </div>
<?php endif; ?>
...
"
   ...
   <?php echo e($navBtnText); ?>
                ...
                <?php if(!empty($isPanel)): ?>
                    ...
                    <?php endif; ?>
                <?php endif; ?>
              <li>            <?php echo $__env->make('web.default.includes.top_nav.user_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                  </li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/web/default/includes/navbar.blade.php ENDPATH**/ ?>