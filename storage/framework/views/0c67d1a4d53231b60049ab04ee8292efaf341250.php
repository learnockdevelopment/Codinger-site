...
<div class="form-group mt-15">
    <label class="mb-2">Course Commission</label>

    <div class="row">
        <div class="col-6">
            <label class="">Type</label>
            <select name="commission_type" value="<?php echo e(!empty($webinar) ? $webinar->commission_type : old('commission_type')); ?>" class="js-commission-type-input form-control" data-currency="<?php echo e($currency); ?>">
        ...
        <div class="col-6">
            <div class="">
                ...
                <input type="number" name="commission_rate" value="<?php echo e(!empty($webinar) ? $webinar->commission_rate : old('commission_rate')); ?>" class="js-commission-value-input form-control text-center" />
            </div>
        </div>
    </div>
...
<div class="form-group mt-30">
    <label for="commissionForSelect"><?php echo e(trans('update.commission_for_instructor_or_system')); ?></label>
    <select name="commission_for" id="commissionForSelect" class="form-control">
        <option value="system" <?php echo e(!empty($webinar) && $webinar->commission_for == 'instructor' ? 'selected' : ''); ?>>
            System
        </option>
        <option value="instructor" <?php echo e(!empty($webinar) && $webinar->commission_for == 'system' ? 'selected' : ''); ?>>
            Instructor
        </option>
    </select>
</div>
...
<!-- Instructor Money Field -->
<div class="form-group">
    <label for="instructor_money"><?php echo e(trans('public.instructor_money')); ?></label>
    <input type="number" name="instructor_money" id="instructor_money" class="form-control" value="<?php echo e(!empty($webinar) ? $webinar->instructor_money : ''); ?>" step="0.01" min="0">
</div>
...
<div class="form-group mt-15">
    <label class="input-label"><?php echo e(trans('public.money_back_days')); ?></label>
    <input type="number" name="money_back_days" value="<?php echo e(old('money_back_days', !empty($webinar) && !empty($webinar->money_back_days) ? $webinar->money_back_days : '')); ?>" class="form-control <?php $__errorArgs = ['money_back_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="<?php echo e(trans('public.enter_money_back_days')); ?>"/>
    <?php $__errorArgs = ['money_back_days'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/webinars/create.blade.php ENDPATH**/ ?>