...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="input-group">
        <div class="input-group-prepend">
            <button type="button" class="input-group-text admin-file-manager" data-input="mobile_app_button_link_<?php echo e($mobileAppButtonsKey); ?>" data-preview="holder">
                <i class="fa fa-link"></i>
            </button>
        </div>
        <input type="text" required
               name="value[mobile_app_buttons][<?php echo e($mobileAppButtonsKey); ?>][link]"
               id="mobile_app_button_link_<?php echo e($mobileAppButtonsKey); ?>"
               class="form-control" placeholder="<?php echo e(trans('admin/main.link')); ?>"
...
<?php $__env->stopPush(); ?><?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/settings/personalization/mobile_app.blade.php ENDPATH**/ ?>