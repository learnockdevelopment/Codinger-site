                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="translate-form" action="<?php echo e(getAdminPanelUrl('/translator/translate')); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="d-flex">
                                    <div class="mr-2">
                                        <button type="submit" class="js-submit-translator btn btn-primary" id="translate-submit"><?php echo e(trans('update.translate')); ?></button>
                                    </div>
                                    <div>
                                        <button type="submit" class="js-manual-translator btn btn-success" id="manual-submit"><?php echo e(trans('update.manual_translate')); ?></button>
                                    </div>
                                </div>
...
<?php $__env->startPush('scripts_bottom'); ?>
    ...
    <script>
        document.getElementById('translate-submit').addEventListener('click', function(event) {
            event.preventDefault();
            // Change form action to the normal translation URL
            document.getElementById('translate-form').action = '<?php echo e(getAdminPanelUrl("/translator/translate")); ?>';
            document.getElementById('translate-form').submit();  // Submit the form
        });

        document.getElementById('manual-submit').addEventListener('click', function(event) {
            event.preventDefault();
            // Change form action to the manual translation URL
            document.getElementById('translate-form').action = '<?php echo e(getAdminPanelUrl("/translator/translate/manual")); ?>';
            document.getElementById('translate-form').submit();  // Submit the form
        });
    </script>
...
<?php echo $__env->make("admin.layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/translator/index.blade.php ENDPATH**/ ?>