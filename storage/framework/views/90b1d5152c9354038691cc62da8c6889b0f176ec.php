...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-3 col-lg-3 mb-40 charge-account-radio">
    <label for="offline" class="rounded-sm p-20 p-lg-45 d-flex flex-column align-items-center justify-content-center">
        <i data-feather="credit-card" width="100" height="100"></i>
        <!-- Voucher Form HTML -->
        <div class="mt-25">
...
document.getElementById('checkVoucher').addEventListener('click', function(event) {
        ...
        if (data.success) {
          ...
          window.location.reload();
            ...
            Swal.fire({
                ...
                timer: 2000,  // Alert closes after 5 seconds
    ...
    .catch(error => {
        ...
        Swal.fire({
            icon: 'error',
            title: 'Error',
            text: error.message || 'An error occurred during voucher validation and application.',
        });
      setTimeout(function () {
          window.location.reload();
        }, 500);
...
<?php echo $__env->make(getTemplate() .'.panel.layouts.panel_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/web/default/panel/financial/account.blade.php ENDPATH**/ ?>