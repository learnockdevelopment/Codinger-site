<?php
    ...
    $isMultiCurrencyEnabled =
        !empty($generalSettings['user_multi_currency']) && $generalSettings['user_multi_currency'];
?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <input type="text" name="full_name"
           value="<?php echo e((!empty($user) && empty($new_user)) ? (app()->getLocale() === 'ar' && !is_null($user->full_arabic_name) ? $user->full_arabic_name : $user->full_name) : old('full_name')); ?>"
                    ...
                    <select name="currency" class="form-control select2" data-allow-clear="false">
                        <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currencyItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($currencyItem->currency); ?>"
                                <?php echo e($userCurrency == $currencyItem->currency ? 'selected' : ''); ?>>
                                <?php echo e(currenciesLists($currencyItem->currency)); ?>

                                (<?php echo e(currencySign($currencyItem->currency)); ?>)</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php else: ?>
                <div class="form-group">
    <label class="input-label"><?php echo e(trans('update.currency')); ?></label>
    <select name="currency" class="form-control select2" data-allow-clear="false" disabled>
        <?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currencyItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($currencyItem->currency); ?>"
                <?php echo e($userCurrency == $currencyItem->currency ? 'selected' : ''); ?>>
                <?php echo e(currenciesLists($currencyItem->currency)); ?>
...
<?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/web/default/panel/setting/setting_includes/basic_information.blade.php ENDPATH**/ ?>