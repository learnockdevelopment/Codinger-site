...
<div class="form-group">
    <label><?php echo e(trans('admin/main.whatsapp_floating_button')); ?></label>
    <input 
        type="text" 
        name="value[whatsapp_floating_button]" 
        value="<?php echo e((!empty($itemValue) and !empty($itemValue['whatsapp_floating_button'])) ? $itemValue['whatsapp_floating_button'] : old('whatsapp_floating_button')); ?>" 
        class="form-control" 
        placeholder="<?php echo e(trans('admin/main.enter_whatsapp_number')); ?>"
    />
    <small class="form-text text-muted">
        <?php echo e(trans('admin/main.whatsapp_button_hint')); ?>
...
<div class="form-group">
    <label class="input-label" for="mobile"><?php echo e(trans('auth.default_country')); ?>:</label>
    <?php
        // Define the default country code
        $defaultCountryCode = 'US'; // Change this to your desired default country code
    ?>
    <select name="value[country_code]" class="form-control select2">
        <?php $__currentLoopData = getCountriesMobileCode(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country => $code): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($code); ?>" 
                    <?php if((!empty($itemValue) and !empty($itemValue['country_code'])) and $itemValue['country_code'] == $code): ?> selected <?php endif; ?> 
                >
                <?php echo e($country); ?>
...
unset($__errorArgs, $__bag); ?>
				...
				<div class="form-group custom-switches-stacked">
    <label class="custom-switch pl-0">
        <input type="hidden" name="value[user_multi_currency]" value="0">
        <input type="checkbox" name="value[user_multi_currency]" id="multiCurrency" value="1" <?php echo e((!empty($itemValue) and !empty($itemValue['user_multi_currency']) and $itemValue['user_multi_currency']) ? 'checked="checked"' : ''); ?> class="custom-switch-input"/>
        <span class="custom-switch-indicator"></span>
        <label class="custom-switch-description mb-0 cursor-pointer" for="multiCurrency"><?php echo e(trans('update.user_multi_currency')); ?></label>
    </label>
    <div class="text-muted text-small mt-1"><?php echo e(trans('update.user_multi_currency_hint')); ?></div>
</div>
...
<?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/settings/general/basic.blade.php ENDPATH**/ ?>