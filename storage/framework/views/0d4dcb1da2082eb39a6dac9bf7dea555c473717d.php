                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="devices-tab" data-toggle="tab" href="#devices" role="tab" aria-controls="badges" aria-selected="true"><?php echo e(trans('admin/main.devices')); ?></a>
                                </li>
                            ...
                            <div class="tab-content" id="myTabContent2">
                                ...
                                <?php echo $__env->make('admin.users.editTabs.devices', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    document.getElementById('localeSelect').addEventListener('change', function() {
        ...
        // Set the 'locale' query parameter to the selected value
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/users/edit.blade.php ENDPATH**/ ?>