    ...
    <section class="section">
        <div class="d-flex flex-wrap align-items-stretch">
            ...
            <div class="text-light p-5 pb-2">
              <div class="mb-2 pb-3">
                <h2 class="mb-2 display-4 font-weight-bold">Learnock LMS</h2>
                <h5 class="font-weight-normal text-muted-transparent">fully-featured educational platform</h5>
              </div>
              All rights reserved for <a class="text-light bb" target="_blank" href="https://www.learnock.com/">Learnock</a>
            </div>
          </div>
            </div>
...
<?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/auth/auth_layout.blade.php ENDPATH**/ ?>