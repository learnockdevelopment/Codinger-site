...
unset($__errorArgs, $__bag); ?>
    ...
    <textarea id="summernote" name="description " class="summernote form-control <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>  is-invalid <?php unset($message);
...
>
        <?php echo !empty($page) ? $page->content : old('content'); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <select name="subscribe_category_id" class="form-control">
        <option value=""><?php echo e(trans('admin/main.select_category')); ?></option>
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($category->id); ?>" <?php echo e((!empty($subscribe) && $subscribe->category_id == $category->id) ? 'selected' : ''); ?>>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/financial/subscribes/new.blade.php ENDPATH**/ ?>