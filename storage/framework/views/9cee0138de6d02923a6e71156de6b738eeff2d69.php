        ...
        <div class="row align-items-center h-100 position-relative">
          ...
          <div class="col-12 col-lg-6 text-white" style="z-index: 2;">
            <div class="top-search-categories-form">
              <h1 class="font-30 mb-15 text-start"><?php echo e(!empty($category) ? $category->title : $pageTitle); ?></h1>
              <span class="course-count-badge py-5 px-10 text-white rounded" style="background: var(--primary);">
                <?php echo e($webinarsCount); ?> <?php echo e(trans('product.courses')); ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/web/default/pages/categories.blade.php ENDPATH**/ ?>