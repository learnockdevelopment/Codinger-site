...
<?php
    $user->full_name = (app()->getLocale() === 'ar' && !is_null($user->full_arabic_name)) ? $user->full_arabic_name : $user->full_name;
?>
                        <tr>
...
<td>
                                <?php echo e(!empty($user->mac_address) ? $user->mac_address : ''); ?>

                            </td>
                          <td>
                                <?php echo e(!empty($user->device_id) ? $user->device_id : ''); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/admin/users/students.blade.php ENDPATH**/ ?>