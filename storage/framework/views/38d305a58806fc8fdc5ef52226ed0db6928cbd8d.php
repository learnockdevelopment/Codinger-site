...
<?php $__env->startSection('content'); ?>
    ...
    <div class="learning-page">
        ...
        <div class="d-flex position-relative">
            <div class="learning-page-content flex-grow-1 bg-info-light p-15 relative">
...
<?php if(!empty($authUser) && !empty($securitySettings['watermark_enabled']) && $securitySettings['watermark_enabled'] !== 0): ?>
    <div id="floating-user-id" class="floating-user-id" style="
        position: absolute;
        color: black;
        padding: 10px;
        border-radius: 5px;
...
<?php echo $__env->make('web.default.layouts.app',['appFooter' => false, 'appHeader' => false], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/codinger/htdocs/codinger.online/resources/views/web/default/course/learningPage/index.blade.php ENDPATH**/ ?>