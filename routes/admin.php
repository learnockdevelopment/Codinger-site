...
Route::group(['prefix' => $prefix, 'namespace' => 'Admin', 'middleware' => ['web', 'admin_locale']], function () use ($prefix) {
    ...
    Route::group(['middleware' => 'admin'], function () {
        ...
        Route::group(['prefix' => 'users'], function () {
          ...
          Route::post('/{id}/updateDevice', 'UserController@updateDevice');
        ...
        Route::group(['prefix' => 'financial'], function () {
            ...
            Route::group(['prefix' => 'vouchers'], function () {
                Route::get('/', 'VoucherController@index');          // List vouchers
                Route::get('/new', 'VoucherController@create');      // Form to create new voucher
                Route::post('/store', 'VoucherController@store');    // Store new voucher
                Route::get('/{id}/edit', 'VoucherController@edit');  // Edit a specific voucher
                Route::post('/{id}/update', 'VoucherController@update'); // Update a specific voucher
                Route::get('/{id}/delete', 'VoucherController@destroy'); // Delete a specific voucher
              Route::get('/{batchName}/vouchers', 'VoucherController@viewGroup'); // Delete a specific voucher
              Route::get('/{batchName}/vouchers/delete', 'VoucherController@deleteGroup'); // Delete a specific voucher
              Route::get('/{batchName}/vouchers/expire', 'VoucherController@expireGroup'); // Delete a specific voucher
Route::get('/excel', 'VoucherController@exportVoucherGroups'); // Delete a specific voucher
              Route::get('/group/{batchName}/pdf', 'VoucherController@exportVouchersInGroupAsPdf'); // Delete a specific voucher
              Route::get('/{voucherId}/pdf', 'VoucherController@exportVoucherAsPdf'); // Delete a specific voucher
Route::get('/{batchName}/vouchers/excel', 'VoucherController@exportVouchers'); // Delete a specific voucher
            });
Route::group(['prefix' => 'qrcodes'], function () {
    Route::get('/', 'QrCodeController@index');                        // List QR code groups
    Route::get('/new', 'QrCodeController@create');                    // Form to create new QR code(s)
    Route::post('/store', 'QrCodeController@store');                  // Store new QR code(s)
    Route::get('/{id}/edit', 'QrCodeController@edit');                // Edit a specific QR code
    Route::post('/{id}/update', 'QrCodeController@update');           // Update a specific QR code
    Route::get('/{id}/delete', 'QrCodeController@destroy');           // Delete a specific QR code

    Route::get('/{batchName}/qrcodes', 'QrCodeController@viewGroup'); // View QR codes in a specific group
    Route::get('/{batchName}/qrcodes/delete', 'QrCodeController@deleteGroup'); // Delete all QR codes in a specific group
    Route::get('/{batchName}/qrcodes/expire', 'QrCodeController@expireGroup'); // Expire all QR codes in a specific group

    Route::get('/excel', 'QrCodeController@exportQrCodeGroups');      // Export QR code groups as Excel
    Route::get('/group/{batchName}/zip', 'QrCodeController@exportQrCodesInGroupAsZip'); // Export QR codes in group as PDF
    Route::get('/{qrCodeId}/pdf', 'QrCodeController@exportQrCodeAsPdf'); // Export a specific QR code as PDF
    Route::get('/{batchName}/qrcodes/excel', 'QrCodeController@exportQrCodes'); // Export QR codes in a specific group as Excel
});
        ...
        Route::group(['prefix' => 'additional_page'], function () {
            Route::group(['prefix' => '/navbar_links'], function () {
               ...
               Route::group(['prefix' => '/about_section'], function () {
                Route::get('/', 'AboutSettingsController@index');
                Route::post('/store', 'AboutSettingsController@store');
                Route::get('/{key}/edit', 'AboutSettingsController@edit');
                Route::get('/{key}/delete', 'AboutSettingsController@delete');
            });
        ...
        Route::group(['prefix' => "/translator"], function () {
          ...
          Route::post("/translate/manual", "TranslatorController@showLangContent");
          Route::post("/translate/manual/translate", "TranslatorController@updateLangContent");
        });
