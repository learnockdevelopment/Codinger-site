...
Route::get('/mobile-app/{iconPath}', 'Web\MobileAppController@downloadFile')->middleware(['share'])->name('mobileAppRoute');
...
Route::post('/enroll_with_qr', 'Web\QrCodeController@enroll');
...
Route::group(['namespace' => 'Web', 'middleware' => ['check_mobile_app', 'impersonate', 'share', 'check_maintenance', 'check_restriction']], function () {
    ...
    Route::get('/subscribe_details/{subscribe_id}', 'SubscribeFlowController@index');
...
Route::get('/learning/{slug}', 'LearningPageController@index');
    ...
    Route::group(['middleware' => 'web.auth'], function () {
        ...
        Route::group(['prefix' => 'cart'], function () {
			...
			Route::post('/voucher/validate', 'VoucherController@validateVoucher'); // Delete a specific voucher
...
//end: All routes inside here will be limited to 5 requests per 1 minute per user/IP
