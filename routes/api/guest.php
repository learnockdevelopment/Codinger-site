...
Route::group([], function () {
  ...
  Route::post('/qrcode', ['uses' => 'QrCodeController@use']);
  Route::post('/qrcode/show', ['uses' => 'QrCodeController@show']);
    Route::get('/system-settings', ['uses' => 'SettingsController@getGeneralSettings']);
