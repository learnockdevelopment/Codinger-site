...
@endphp
    <div class="custom-dropdown navbar-auth-user-dropdown position-relative ml-20" >
        <div class="custom-dropdown-toggle d-flex align-items-center navbar-user cursor-pointer">
            <img 
    src="{{ $authUser->avatar ?: '/store/1/default.png' }}" 
    class="rounded-circle size-40" 
    alt="{{ $authUser->full_name }}">
            <span class="font-16 user-name ml-10 text-dark-blue font-14 lg:inline-block! hidden!">{{ $authUser->full_name }}</span>
        </div>
...
@else
    <!-- <div class="d-flex align-items-center ml-md-50"> -->
       <!-- <a href="/login" class="py-5 px-10 mr-10 text-dark-blue font-14" style="font-size:22px;color:#C833E2;">{{ trans('auth.login') }}</a> -->
      <!--  <a href="/register" class="py-5 px-10 mr-10 text-dark-blue font-14" style="font-size:22px;color:#C833E2;">{{ trans('auth.register') }}</a> -->
    <!-- </div> -->
@endif
