...
<div class="form-group">
    <label>{{ trans('admin/main.color') }}</label>
    <input type="color" name="color"
           class="form-control  @error('color') is-invalid @enderror"
           value="{{ !empty($category) ? $category->color : old('color', '#ffffff') }}"
           placeholder="{{ trans('admin/main.choose_color') }}" style="width:20%;"/>
    @error('color')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
...
<div class="form-group">
    ...
    <input type="color" name="text_color"
           ...
           value="{{ !empty($category) ? $category->text_color : old('text_color', '#000000') }}"
           placeholder="{{ trans('admin/main.choose_text_color') }}" style="width:20%;"/>
    @error('text_color')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
...
<div class="form-group">
    <label>{{ trans('admin/main.grade') }}</label>
    <input type="text" name="grade"
           class="form-control  @error('grade') is-invalid @enderror"
           value="{{ !empty($category) ? $category->grade : old('grade') }}"
           placeholder="{{ trans('admin/main.choose_grade') }}"/>
    @error('grade')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
...
<div class="form-group">
    <label>{{ trans('admin/main.age_min') }}</label>
    <input type="number" name="age_min"
           class="form-control  @error('age_min') is-invalid @enderror"
           value="{{ !empty($category) ? $category->age_min : old('age_min') }}"
           placeholder="{{ trans('admin/main.choose_age_min') }}"/>
    @error('age_min')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
...
<div class="form-group">
    <label>{{ trans('admin/main.age_max') }}</label>
    <input type="number" name="age_max"
           class="form-control  @error('age_max') is-invalid @enderror"
           value="{{ !empty($category) ? $category->age_max : old('age_max') }}"
           placeholder="{{ trans('admin/main.choose_age_max') }}"/>
    @error('age_max')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
