...
<div class="input-group-prepend">
										...
										<input type="text" name="color"
                                               autocomplete="off" id="color" value="{{ !empty($trend) ? $trend->color : old('color') }}"
                                               placeholder="{{ trans('admin/main.trend_color_placeholder') }}" class="form-control  @error('color') is-invalid @enderror">
                                        <div class="input-group-append">
                                            <button type="button" class="input-group-text admin-file-view" data-input="icon">
                                                <i class="fa fa-eye"></i>
                                            </button>
