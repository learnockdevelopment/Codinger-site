...
<div class="form-group mt-15">
    ...
    <div class="row">
        <div class="col-6">
            ...
            <select name="commission_type" value="{{ !empty($webinar) ? $webinar->commission_type : old('commission_type') }}" class="js-commission-type-input form-control" data-currency="{{ $currency }}">
        ...
        <div class="col-6">
            <div class="">
                ...
                <input type="number" name="commission_rate" value="{{ !empty($webinar) ? $webinar->commission_rate : old('commission_rate') }}" class="js-commission-value-input form-control text-center" />
            </div>
        </div>
    </div>
...
<div class="form-group mt-30">
    <label for="commissionForSelect">{{ trans('update.commission_for_instructor_or_system') }}</label>
    <select name="commission_for" id="commissionForSelect" class="form-control">
        <option value="system" {{ !empty($webinar) && $webinar->commission_for == 'instructor' ? 'selected' : '' }}>
            System
        </option>
        <option value="instructor" {{ !empty($webinar) && $webinar->commission_for == 'system' ? 'selected' : '' }}>
            Instructor
        </option>
    </select>
</div>
...
<div class="form-group">
    <label for="instructor_money">{{ trans('public.instructor_money') }}</label>
    <input type="number" name="instructor_money" id="instructor_money" class="form-control" value="{{ !empty($webinar) ? $webinar->instructor_money : '' }}" step="0.01" min="0">
</div>
...
<div class="form-group mt-15">
    <label class="input-label">{{ trans('public.money_back_days') }}</label>
    <input type="number" name="money_back_days" value="{{ old('money_back_days', !empty($webinar) && !empty($webinar->money_back_days) ? $webinar->money_back_days : '') }}" class="form-control @error('money_back_days') is-invalid @enderror" placeholder="{{ trans('public.enter_money_back_days') }}"/>
    @error('money_back_days')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
    @enderror
