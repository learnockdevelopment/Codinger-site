...
<div class="mt-3" id="mobile_app">
    ...
    <div class="input-group">
        <div class="input-group-prepend">
            <button type="button" class="input-group-text admin-file-manager" data-input="mobile_app_button_link_{{ $mobileAppButtonsKey }}" data-preview="holder">
                <i class="fa fa-link"></i>
            </button>
        </div>
        <input type="text" required
               name="value[mobile_app_buttons][{{ $mobileAppButtonsKey }}][link]"
               id="mobile_app_button_link_{{ $mobileAppButtonsKey }}"
               class="form-control" placeholder="{{ trans('admin/main.link') }}"
