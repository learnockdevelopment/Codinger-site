                            ...
                            @foreach($supports as $support)
                                <tr>
                                    ...
                                    <td class="text-center" width="50">
                                        ...
                                        @endcan
                                      @can('admin_supports_delete')
                                      <a href="{{ getAdminPanelUrl() }}/supports/{{ $support->id }}/close" class="btn-transparent btn-sm text-primary" data-toggle="tooltip" data-placement="top" title="{{ trans('admin/main.close') }}">
                                                Close
                                            </a>
@endcan
                                    </td>
