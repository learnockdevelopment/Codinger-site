<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
                ...
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @can('admin_certificate_settings')
                            <li
                                class="{{ request()->is(getAdminPanelUrl('/certificates/settings', false)) ? 'active' : '' }}">
                                <a class="nav-link"
          ...
          <li
    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/qrcodes*', false)) ? 'active' : '' }}">
    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
        <i class="fas fa-qrcode"></i>
        <span>{{ trans('admin/main.qrcodes') }}</span>
    </a>
    <ul class="dropdown-menu">
        <li
            class="{{ (request()->is(getAdminPanelUrl('/financial/qrcodes', false)) and empty(request()->get('instructor_qrcodes'))) ? 'active' : '' }}">
            <a class="nav-link"
                href="{{ getAdminPanelUrl() }}/financial/qrcodes">{{ trans('admin/main.qr_lists') }}</a>
        </li>
        
        <li
            class="{{ request()->is(getAdminPanelUrl('/financial/qrcodes/new', false)) ? 'active' : '' }}">
            <a class="nav-link"
                href="{{ getAdminPanelUrl() }}/financial/qrcodes/new">{{ trans('admin/main.new_qrcode') }}</a>
        </li>
    </ul>
</li>
            @endcan
            ...
            @can('admin_categories')
                <li
                    class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/subject*', false)) ? 'active' : '' }}">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
				<i class="fas fa-table"></i>   
                      <span>{{ trans('admin/main.subject_section') }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        @can('admin_categories_list')
                            <li class="{{ request()->is(getAdminPanelUrl('/subject', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/subject">{{ trans('admin/main.lists') }}</a>
                            </li>
                        @endcan()
                        @can('admin_categories_create')
                            <li class="{{ request()->is(getAdminPanelUrl('/subject/create', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/subject/create">{{ trans('admin/main.new') }}</a>
                            </li>
                        @endcan()
            ...
            @can('admin_additional_pages')
                <li
                    ...
                    <ul class="dropdown-menu">
                        ...
                        @endcan()
                      <li
                                class="{{ request()->is(getAdminPanelUrl('/additional_page/about_section', false)) ? 'active' : '' }}">
                                <a class="nav-link"
                                    href="{{ getAdminPanelUrl() }}/additional_page/about_section">{{ trans('admin/main.about') }}</a>
                            </li>
                    </ul>
                </li>
            @endcan
            ...
            @endif
            <li
                class="nav-item dropdown {{ request()->is(getAdminPanelUrl('/financial/vouchers*', false)) ? 'active' : '' }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                    <i class="fas fa-ticket-alt"></i>
                    <span>{{ trans('admin/main.vouchers') }}</span>
                </a>
                <ul class="dropdown-menu">
                    <li
                        class="{{ (request()->is(getAdminPanelUrl('/financial/vouchers', false)) and empty(request()->get('instructor_vouchers'))) ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ getAdminPanelUrl() }}/financial/vouchers">{{ trans('admin/main.lists') }}</a>

                    <li
                        class="{{ request()->is(getAdminPanelUrl('/financial/vouchers/new', false)) ? 'active' : '' }}">
                        <a class="nav-link"
                            href="{{ getAdminPanelUrl() }}/financial/vouchers/new">{{ trans('admin/main.new') }}</a>
                    </li>
            ...
            @endcan
<li class="nav-item {{ request()->is(getAdminPanelUrl('/financial/sales*', false)) ? 'active' : '' }}">
        <a href="{{ getAdminPanelUrl() }}/financial/sales?status=refund" class="nav-link">
            <i class="fas fa-list-ul"></i>
            <span>{{ trans('admin/main.refund_list') }}</span>
        </a>
    </li>
            @can('admin_payouts')
                <li
