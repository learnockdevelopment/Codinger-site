                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="translate-form" action="{{ getAdminPanelUrl('/translator/translate') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="d-flex">
                                    <div class="mr-2">
                                        <button type="submit" class="js-submit-translator btn btn-primary" id="translate-submit">{{ trans('update.translate') }}</button>
                                    </div>
                                    <div>
                                        <button type="submit" class="js-manual-translator btn btn-success" id="manual-submit">{{ trans('update.manual_translate') }}</button>
                                    </div>
                                </div>
...
@push('scripts_bottom')
    ...
    <script>
        document.getElementById('translate-submit').addEventListener('click', function(event) {
            ...
            document.getElementById('translate-form').action = '{{ getAdminPanelUrl("/translator/translate") }}';
        ...
        document.getElementById('manual-submit').addEventListener('click', function(event) {
            ...
            document.getElementById('translate-form').action = '{{ getAdminPanelUrl("/translator/translate/manual") }}';
            document.getElementById('translate-form').submit();  // Submit the form
        });
    </script>
