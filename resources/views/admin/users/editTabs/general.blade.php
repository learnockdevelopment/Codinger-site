...
<div class="form-group">
    <label>{{ trans('/admin/main.full_arabic_name') }}</label>
    <input type="text" name="full_arabic_name"
           class="form-control  @error('full_arabic_name') is-invalid @enderror"
           value="{{ !empty($user) ? $user->full_arabic_name : old('full_arabic_name') }}"
           placeholder="{{ trans('admin/main.full_arabic_name') }}"/>
    @error('full_arabic_name')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
    @enderror
