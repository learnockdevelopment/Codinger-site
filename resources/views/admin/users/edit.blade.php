                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="devices-tab" data-toggle="tab" href="#devices" role="tab" aria-controls="badges" aria-selected="true">{{ trans('admin/main.devices') }}</a>
                                </li>
                            ...
                            <div class="tab-content" id="myTabContent2">
                                ...
                                @include('admin.users.editTabs.devices')
