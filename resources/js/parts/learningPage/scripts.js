...
$('body').on('mouseenter', '.learning-page-tabs', function () {
  var $tabs = $('.learning-page-tabs');
  $tabs.addClass('show');
});

$('body').on('mouseleave', '.learning-page-tabs', function () {
  var $tabs = $('.learning-page-tabs');
  $tabs.removeClass('show');
});

// Toggle tabs visibility when collapse button is clicked
...
$(document).ready(function() {
    $('[data-fullscreen-button="true"]').hide();
});
...
$(document).ready(function() {
    ...
    // Detect fullscreen change and disable it
    $(document).on('fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange', function() {
        if (document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || document.msFullscreenElement) {
            console.log("Fullscreen mode detected.");
            exitFullscreen();  // Exit fullscreen if the page enters fullscreen mode
        } else {
...
$('body').on('click', function() {
    // Disable fullscreen for all iframes
    $('iframe').each(function() {
        // Set the iframe's allowfullscreen attribute to false
        $(this).removeAttr('allowfullscreen');
        console.log("Fullscreen disabled for iframe with src: " + $(this).attr('src'));
    });

    // Optionally, handle fullscreen change detection for iframes
    $(document).on('fullscreenchange webkitfullscreenchange mozfullscreenchange msfullscreenchange', function() {
        if (document.fullscreenElement || document.webkitFullscreenElement || document.mozFullScreenElement || document.msFullscreenElement) {
            // Check if the fullscreen element is an iframe, and exit if so
            if ($('iframe').has($(document.fullscreenElement)).length) {
                console.log("Fullscreen mode detected in iframe. Exiting fullscreen.");
                document.exitFullscreen();
            }
        }
    });
