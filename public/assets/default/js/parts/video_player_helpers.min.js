...
window.makeVideoPlayerHtml = function (path, storage, height, tagId) {
  ...
  if (storage === 'youtube' || storage === 'vimeo') {
    ...
    html = '<iframe src="' + path + '?controls=false" class="img-cover bg-gray200" frameborder="0" loading="lazy" allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;"></iframe>';
  } else {
